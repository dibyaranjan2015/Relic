...
{
if(isset($_POST['answer']) && $_POST['answer']=="fivefour")
{
...
<img src="../images/actor.png" title="actor" style="width:40%;margin-bottom:5%;margin-top:5%" /><br/>
<img src="../images/2008.png" title="2008" style="width:40%;margin-bottom:5%" />
<form style="padding-top:5%" name="answer_form" method="POST" action="u+2212.php">
