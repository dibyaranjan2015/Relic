...
{
if(isset($_POST['answer']) && $_POST['answer']=="japan")
{
...
<img src="../images/p3_q2.png" style="margin-top:5%;max-width:40%;max-height:60%;" title="prize" />
<form style="padding-top:5%" name="answer_form" method="POST" action="country.php">
