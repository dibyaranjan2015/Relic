...
<!-- ktj.in/static/clue.png -->
<img src="../images/p3_q6.png" style="max-width:40%;max-height:60%;" title="" />
<form style="padding-top:5%" name="answer_form" method="POST" action="math.php">
