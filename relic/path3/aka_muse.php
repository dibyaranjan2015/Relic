...
if(isset($_SESSION['loggedin']) && $_SESSION['loggedin']==1 && $r==1 && !($r1['qno']>$qno)  && $r1==1)
{
if(isset($_POST['answer']) && $_POST['answer']=="boeing")
{
...
<img src="../images/aka_muse.jpg" title="aka_muse" style="width:50%;margin-bottom:5%" />
<form style="padding-top:5%" name="answer_form" method="POST" action="aka_muse.php">
