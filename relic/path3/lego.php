...
{
if(isset($_POST['answer']) && $_POST['answer']=="starlord")
{
...
<!-- “And OURS shall be in a CENTAUR WITH A BOW” -->
<img src="../images/p3_q5.png" style="max-width:40%;max-height:60%;" title=""/>
<form style="padding-top:5%" name="answer_form" method="POST" action="lego.php">
