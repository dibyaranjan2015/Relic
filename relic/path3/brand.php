...
{
if(isset($_POST['answer']) && $_POST['answer']=="katyperry")
{
...
<!-- Search for clues everywhere, even in Mark Zukerberg’s gift to us. -->
<div id="content" class="content" style="display:shown">
<div class="question" id="question1">
<img src="../images/p3_q3.png" style="margin-top:5%;max-width:40%;max-height:60%;" /><br/>
<form style="padding-top:5%" name="answer_form" method="POST" action="brand.php">
