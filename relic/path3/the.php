...
{
if(isset($_POST['answer']) && $_POST['answer']=="jameslordpierpont")
{
...
<!--
Bell : Phone : : Answer : Question
-->

<div id="content" class="content" style="display:shown">
<div class="question" id="question1">
<img src="../images/play-it.jpg" title="play it" style="width:40%;margin-bottom:5%" />
<form style="padding-top:5%" name="answer_form" method="POST" action="the.php">
