...
$r=mysql_num_rows($q);
$a = mysql_query("SELECT * FROM `relic_answer` WHERE `id`='14'");
...
<div class="container" id='container'>
 <div class="page-header">
  ...
  <div class="row">
  <div class="col-sm-8" style='background:#fff;position:relative;left:-1vw;height:55vh;border-radius:5px;opacity:0.9;'>
  <div class="sherlock">
   MEMNE<BR>
   ISCGT<BR>
   SSOTY<BR>
...
<div class="row">
<h4>The Emperor and his wife visits Sherlock the same day.
<br><br>The murderer sent a note to them as well!

</h4>

</div>

<form method='post' action='p1q4.php'>
<div class="row">
