...
{
if(isset($_POST['answer']) && $_POST['answer']=="cancer")
{
...
<img src="../images/ignorance.png" title="ignorance" style="width:80%;margin-bottom:5%" />
<form style="padding-top:2%" name="answer_form" method="POST" action="font.php">
