...
{
if(isset($_POST['answer']) && $_POST['answer']=="rosetta")
{
...
<img src="../images/p4_q1.png" style="margin-top:5%;max-width:40%;max-height:60%;" title="sixsevenP/c-g" />
<form style="padding-top:2%" name="answer_form" method="POST" action="vehicle.php">
