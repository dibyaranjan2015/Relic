...
{
if(isset($_POST['answer']) && $_POST['answer']=="deadpool")
{
...
<img src="../images/p4_q4.png" style="margin-top:5%;max-width:40%;max-height:60%;" title=""/>
<form style="padding-top:2%" name="answer_form" method="POST" action="weapon.php">
