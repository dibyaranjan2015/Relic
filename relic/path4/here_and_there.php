...
{
if(isset($_POST['answer']) && $_POST['answer']=="pompeii")
{
...
sometimes the answers are just around.

------------------------------->

<div id="content" class="content" style="display:shown">
<div class="question" id="question1">
<img src="../images/heat.jpg" title="undertheheat" style="width:45%;margin-bottom:5%"/>
<form style="padding-top:2%" name="answer_form" method="POST" action="here_and_there.php">
