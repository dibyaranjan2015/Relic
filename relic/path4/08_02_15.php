...
{
if(isset($_POST['answer']) && $_POST['answer']=="jackgleeson")
{
...
<img src="../images/p4_q5.png" title="" style="width:45%;margin-bottom:5%"/>

<form style="padding-top:2%" name="answer_form" method="POST" action="08_02_15.php">
