...
{
if(isset($_POST['answer']) && $_POST['answer']==$_SESSION['email'])
{
$qry=mysql_query("INSERT INTO `relic_email`(`email`) VALUES ('".mysql_real_escape_string($_SESSION['email'])."')");
header("Location:contact.php");
}
else if(isset($_POST['answer']) && $_POST['answer']=="statueofliberty")
{
...
<iframe width="420" height="315" src="//www.youtube.com/embed/kG8l7K9qlG0?rel=0" frameborder="0" allowfullscreen></iframe>
<form style="padding-top:2%" name="answer_form" method="POST" action="zip.php">
