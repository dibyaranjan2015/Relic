...
{
if(isset($_POST['answer']) && $_POST['answer']=="twonine")
{
...
He sits beside us,<br/>
amid the Passion of Jesus,<br/>
but we are fairly small.<br/>
Claims he himself Jan was here,<br/>
They see them and they see them, <br/>
but he is the one who sees them all.<br/>
<br/>
Jan asks us "hoeveel zijn we"?<br/>

<form style="padding-top:2%" name="answer_form" method="POST" action="daretosolve.php">
