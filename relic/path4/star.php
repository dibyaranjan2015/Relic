...
{
if(isset($_POST['answer']) && $_POST['answer']=="shahrukhkhan")
{
...
<img src="../images/p4_q6.png" style="margin-top:5%;max-width:80%;max-height:60%;" title="town"/>

<form style="padding-top:2%" name="answer_form" method="POST" action="star.php">
